...
import com.pm.patientservice.infrastructure.exception.ApiResponse;
...
public class PatientController {
    ...
    public ResponseEntity<ApiResponse<PatientResponseDTO>> createPatient(
        ...
        return ResponseEntity.ok(ApiResponse.success(patientResponseDTO));
    }
    ...
    @PreAuthorize("hasAnyRole('USER','ADMIN')")
    public ResponseEntity<ApiResponse<PatientResponseDTO>> updatePatientImage(
            @PathVariable UUID id,
            @RequestBody @Validated PatientImageRequestDTO requestDTO) {
        return ResponseEntity.ok(ApiResponse.success(patientService.updatePatientImage(id, requestDTO.getProfileImageUrl())));
    }
