...
public interface DoctorClient {
    ...
    ApiResponse<DoctorResponseDTO> getDoctorById(@PathVariable("id") UUID doctorId);

    @GetMapping("/doctors/{id}/schedules")
    ApiResponse<List<DoctorScheduleDTO>> getDoctorSchedules(@PathVariable("id") UUID doctorId,
